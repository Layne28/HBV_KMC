...
void dump_lammps_traj(System &g, int time0)
{
	...
	FILE *f;
	f = fopen((g.get_obs().output_dir + "trajlammps_bonds.dat").c_str(), "a");
...
{ //currently no drug
	...
	FILE *f;
	f = fopen((g.get_obs().output_dir + "trajlammps_restart.dat").c_str(), "a");
	//fprintf(f,"@<TRIPOS>MOLECULE\n");
...
void dump_lammps_traj_dimers(System &g, int time0)
{
	...
	FILE *f;
	f = fopen((g.get_obs().output_dir + "trajlammps.dat").c_str(), "a");
	//fprintf(f,"@<TRIPOS>MOLECULE\n");
