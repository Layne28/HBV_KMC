...
int main(int argc, char **argv)
{
    ...
    g.epsilon[0] = atof(argv[2]);    //bond spring constant
    g.epsilon[1] = g.epsilon[0];     //""
    g.epsilon[2] = g.epsilon[0];     //""
    g.epsilon[3] = g.epsilon[0];     //""
    g.kappa[0] = atof(argv[3]);      //angle spring constant
    g.kappa[1] = g.kappa[0];         //""  
    g.kappa[2] = g.kappa[0];         //""
    g.kappa[3] = g.kappa[0];         //""
    double Phikappa = atof(argv[4]); //dihedral spring constant
    ...
    double ks0 = atof(argv[9]); //relative rate of dimer binding to elastic relaxation
