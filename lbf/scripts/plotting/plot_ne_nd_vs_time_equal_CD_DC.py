...
#insert images
im1 = image.imread('equal_CD_DC.tga')
imagebox = OffsetImage(im1, zoom=0.08)
ab = AnnotationBbox(imagebox, xy=(1500,450),xybox=(2000,750),frameon=False, bboxprops=dict(edgecolor='black'),arrowprops=dict(arrowstyle='-',color='black'))
ax = plt.gca()
ax.add_artist(ab)
